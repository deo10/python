...
room_types: tuple[str, str, str] = ('single', 'double', 'suite')
...
class HotelBookingService:
    ...
    def __init__(self) -> None:
        self.rooms = [Room(101, random.choice(room_types)),
                      Room(102, random.choice(room_types)),
                      Room(103, random.choice(room_types))]
